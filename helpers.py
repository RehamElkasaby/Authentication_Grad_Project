...
def match_user_id_pic(ID_path,pic_path):
    """ This function,compare two images to make sure that they are the same person, using deepface library and
    ArcFace model for face recognition.
    Args:
        ID_path (path): ID image from database
        pic_path (_type_): normal picture of the person
    Returns: 
        boolean: True if the same person.
    """
